...
namespace tbb {
  ...
  inline void t_debug_task::spawn(task& t, const char* file, int line, bool par_for) {
    /*PROF CALL*/taskProf->TP_CaptureSpawn_Entry(get_cur_tid(),file,line);
    ...
    /*PROF CALL*/taskProf->TP_CaptureSpawn_Exit(get_cur_tid(),file,line);
  }
  ...
  inline void t_debug_task::spawn_and_wait_for_all( task& child,const char* file, int line ) {
    /*PROF CALL*/taskProf->TP_CaptureWait_Entry(get_cur_tid(),file,line);
    ...
    /*PROF CALL*/taskProf->TP_CaptureWait_Exit(get_cur_tid(),file,line);
  }
